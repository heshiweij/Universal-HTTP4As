...
public class SDCardHelper {
	...
	/*
	 ...
	 /storage/emulated/0/Music   (获取SD卡公有目录的路径)
 	/storage/emulated/0/Android/data/cn.ifavor.networkutil/cache  (获取SD卡私有Cache目录的路径)
    /storage/emulated/0/Android/data/cn.ifavor.networkutil/files/Music  (获取SD卡私有Files目录的路径)
